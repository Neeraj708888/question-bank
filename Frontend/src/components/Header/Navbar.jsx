...
import { Menu, X } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
>>>>>>> 0bce0ea94a145f96b22b12984c97658aa05b9884
...
<<<<<<< HEAD
          ...
          <div className="hidden md:flex items-center space-x-4 font-semibold ">
            <button
              className="hover:bg-blue-600 px-1 py-1 rounded-md text-md"
              onClick={() => navigate("/")}
            >
              Home
            </button>
            <button
              className="hover:bg-blue-600 px-1.5 py-1.5 rounded-md text-md"
              onClick={() => navigate("/login")}
            >
              Login
            </button>
            <button
              className="hover:bg-blue-600 px-2 py-2 rounded-md text-md"
            ...
            <button
                className="hover:bg-blue-600 px-3 py-2 rounded-md text-md flex items-center gap-2 transition-colors duration-300 w-full sm:w-auto"
...
>>>>>>> 0bce0ea94a145f96b22b12984c97658aa05b9884
      ...
      {isOpen && (
        <div className="md:hidden px-4 pb-4 space-y-2 flex flex-col">
          <button
            className="hover:bg-blue-600 px-1 py-1 rounded-md text-xl"
            onClick={() => navigate("/")}
          >
            Home
          </button>
          <button
            className="hover:bg-blue-600 px-1.5 py-1.5 rounded-md text-xl"
            onClick={() => navigate("/login")}
          >
            Login
          </button>
          <button
            className="hover:bg-blue-600 px-2 py-2 rounded-md text-xl"
            onClick={() => navigate("/topics")}
          >
            Topic
          </button>
